# Docker image for sqlite using the alpine template
ARG IMAGE_NAME="sqlite"
ARG PHP_SERVER="sqlite"
ARG BUILD_DATE="Wed Aug 23 07:27:58 PM EDT 2023"
ARG LANGUAGE="en_US.UTF-8"
ARG TIMEZONE="America/New_York"
ARG WWW_ROOT_DIR="/usr/share/webapps/sqlite"
...
ARG PACK_LIST="sqlite3 nginx nginx-mod-http-brotli nginx-mod-http-cache-purge nginx-mod-http-dav-ext nginx-mod-http-echo \
...
ENV HOSTNAME="casjaysdev-sqlite"
...
LABEL org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/sqlite"
LABEL org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/sqlite"
LABEL org.opencontainers.image.vcs-type="Git"
LABEL org.opencontainers.image.vcs-ref="${BUILD_VERSION}"
LABEL org.opencontainers.image.vcs-url="https://hub.docker.com/r/casjaysdevdocker/sqlite"
LABEL org.opencontainers.image.documentation="https://hub.docker.com/r/casjaysdevdocker/sqlite"
